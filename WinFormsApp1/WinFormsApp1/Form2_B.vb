...
Public Class Form2_B
    ...
    Private Sub PrintContent(sender As Object, e As PrintPageEventArgs)
        ...
        Dim label2X As Single = 580 ' Adjust x coordinate for Label2
        ...
        Dim label7x As Single = 560 ' adjust x coordinate for label3
        ...
        Dim label8X As Single = 560 ' Adjust x coordinate for Label3
