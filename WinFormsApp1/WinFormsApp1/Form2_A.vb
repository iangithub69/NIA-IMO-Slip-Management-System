...
Public Class Form2_A
    ...
    Private Sub Form2_A_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub PrintContent(sender As Object, e As PrintPageEventArgs)
        ...
        Dim label4Y As Single = 410 ' Adjust y coordinate for Label3 /pesos
        ...
        Dim label10X As Single = 50 ' Adjust x coordinate for Label1
        Dim label10Y As Single = 310 ' Adjust y coordinate for Label1 /date
        e.Graphics.DrawString(Label10.Text, font, brush, label10X, label10Y)
        y += lineHeight

        Dim label11X As Single = 210 ' Adjust x coordinate for Label1
        Dim label11Y As Single = 310 ' Adjust y coordinate for Label1 /date
        e.Graphics.DrawString(Label11.Text, font, brush, label11X, label11Y)
        y += lineHeight

        Dim label12X As Single = 590 ' Adjust x coordinate for Label1
        Dim label12Y As Single = 310 ' Adjust y coordinate for Label1 /date
