...
Partial Class Form2_F
    ...
    Private Sub InitializeComponent()
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(Form2_F))
        ...
        DataGridViewCellStyle7.SelectionBackColor = Color.FromArgb(CByte(0), CByte(192), CByte(0))
        ...
        DataGridViewCellStyle8.SelectionBackColor = Color.FromArgb(CByte(0), CByte(192), CByte(0))
        ...
        DataGridViewCellStyle9.BackColor = Color.FromArgb(CByte(0), CByte(192), CByte(0))
